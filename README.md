...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create was-pg-a76d
  fly apps create was-pg-a76d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app was-pg-a76d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app was-pg-a76d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'was-pg-a76d-staging' does not match app name in config file 'was-pg-a76d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name was-pg-a76d-db
  fly postgres attach --app was-pg-a76d was-pg-a76d-db

  fly postgres create --name was-pg-a76d-staging-db
  fly postgres attach --app was-pg-a76d-staging was-pg-a76d-staging-db
  ```
